...
static func run_all() -> Dictionary:
	...
	var failures: Array = board_result.failures + agent_result.failures + observation_result.failures + neural_result.failures
	var passed: int = board_result.passed + agent_result.passed + observation_result.passed + neural_result.passed
